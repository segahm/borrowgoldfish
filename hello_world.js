...
function startServer() {
	...
	app.use('/index_files',express.static(__dirname+'/index_files',{ maxAge: 0 }));
	app.use('/static',express.static(__dirname+'/static',{ maxAge: 0 }));
	...
	app.use(function(req, res, next){
		...
		res.send('<h2>Service Temporarily Unavailable</h2><div>The server is temporarily unable to service your request due to maintenance downtime or capacity problems. Please try again later. '+ar+'</div>');
		//}
	});
