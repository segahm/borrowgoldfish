    ...
    app.use(function(req, res, next) {
        ...
        resultPromise.then(function(mypage) {
            ...
            if (mypage === 'index' || mypage === '404') {
                return homePage(req, template_data, template).then(function(status) {
...
companyPage = function(template_data, company_id, template) {
    var page;
    return Company.prototype.findById(company_id).then(function(data) {
